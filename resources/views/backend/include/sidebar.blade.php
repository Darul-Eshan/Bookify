<aside class="w-64 bg-[#121222] border-r border-gray-800 flex flex-col fixed inset-y-0 left-0 z-40 transition-transform duration-300 lg:translate-x-0 overflow-hidden" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'">
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6 space-y-1.5">
        ...
        <!-- Home / Website Homepage Link Added Here -->
        <a href="{{ route('home') }}" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('home') ? 'bg-purple-600/10 text-purple-400 font-semibold' : 'text-gray-400 hover:text-white hover:bg-[#161628]' }} font-medium text-sm transition">
        ...
        <!-- Bookings & Tickets -->
        <a href="{{ route('admin.bookings') }}" class="flex items-center gap-3 px-4 py-3 text-sm {{ request()->routeIs('admin.bookings') ? 'bg-purple-600/10 text-purple-400 font-semibold' : 'text-gray-400 hover:text-white hover:bg-[#161628]' }} rounded-xl transition">
    ...
    <div class="p-4 border-t border-gray-800">
        <a href="{{ route('home') }}" target="_blank" class="flex items-center gap-3 px-4 py-3 rounded-xl text-red-400 hover:bg-red-500/10 font-medium text-sm transition">
