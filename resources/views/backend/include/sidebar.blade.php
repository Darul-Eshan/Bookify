...
<div x-show="open" x-transition.origin.top.duration.200ms class="pl-11 pr-2 space-y-1 py-1" style="display: none;">
    ...
    <a href="{{ route('admin.event.venues') }}" class="block px-3 py-2 rounded-lg text-xs font-medium {{ request()->routeIs('admin.event.venues') ? 'text-purple-400 bg-purple-600/10' : 'text-gray-400 hover:text-white hover:bg-[#161628]' }} transition">
        Venues & Locations
    </a>
</div>
        </div>
