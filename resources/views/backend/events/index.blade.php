...
<body class="bg-[#0B0B14] text-gray-200 antialiased" x-data="{ sidebarOpen: false, editEventModal: false, activeEvent: {} }">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-[#0B0B14] p-6">
                ...
                <div class="mb-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="{{ route('admin.events.create') }}" class="px-4 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-semibold text-sm rounded-xl shadow-lg shadow-purple-600/30 transition flex items-center gap-2">
                                    ...
                                    <tr>
                                        <td class="p-3">
                                            <div class="flex items-center gap-3">
                                                <img src="{{ asset('storage/' . $event->image) }}" class="w-12 h-12 rounded-xl object-cover border border-gray-700" alt="Event">
                                                <div>
                                    ...
                                    <tr>
                                        <td colspan="7" class="p-8 text-center text-gray-400 text-sm">
                                            <div class="flex flex-col items-center justify-center space-y-3">
                                                ...
                                                <a href="{{ route('admin.events.create') }}" class="text-xs px-3 py-1.5 bg-purple-600 text-white rounded-lg hover:bg-purple-500 transition">Create Your First Event</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                ...
                <div x-show="editEventModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 overflow-y-auto" style="display: none;">
                    <div @click.away="editEventModal = false" class="bg-[#121222] border border-gray-800 rounded-2xl w-full max-w-2xl p-6 shadow-2xl text-white my-8">
                        ...
                        <form :action="'/admin/events/update/' + activeEvent.id" method="POST" enctype="multipart/form-data" class="py-4 space-y-4">
                            @csrf
                            @method('PUT')
