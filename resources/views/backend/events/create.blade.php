        ...
        <div class="flex-1 flex flex-col lg:pl-64 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-[#0B0B14] p-6">
                ...
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.events') }}"
                            class="text-xs text-purple-400 hover:text-purple-300 font-semibold flex items-center gap-1 mb-1 transition">
                ...
                @if (session('success'))
                    ...
                    <div
                        class="max-w-4xl mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl text-emerald-400 text-sm flex items-center gap-3 shadow-lg">
                ...
                @if ($errors->any())
                    ...
                    <div
                        class="max-w-4xl mb-6 p-4 bg-red-500/10 border border-red-500/30 rounded-2xl text-red-400 text-sm shadow-lg">
                    ...
                    <form action="{{ route('admin.events.store') }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select
                                    name="category"
                                    required
                                    class="w-full bg-[#18182f] text-sm text-gray-200 border @error('category') border-red-500 @else border-gray-800 @enderror rounded-xl px-4 py-3 focus:outline-none focus:border-purple-500 transition"
                                >
                                    ...
                                    <option value="Concert" {{ old('category') == 'Concert' ? 'selected' : '' }}>
                                        Concert
                                    </option>
                                    ...
                                    <option value="Tech Summit" {{ old('category') == 'Tech Summit' ? 'selected' : '' }}>
                                        Tech Summit
                                    </option>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full bg-[#18182f] text-sm text-gray-200 border @error('description') border-red-500 @else border-gray-800 @enderror rounded-xl px-4 py-3 focus:outline-none focus:border-purple-500 transition resize-none"
                        ...
                        <!-- Image Upload Box with Preview & Delete -->
                        <div x-data="{ imagePreview: null }">
                            ...
                            <div
                                x-show="!imagePreview"
                                class="relative border-2 border-dashed border-gray-700 hover:border-purple-500/80 bg-[#18182f] rounded-2xl p-6 text-center cursor-pointer transition group"
                            >
                            ...
                            <!-- State 2: Image Preview & Delete -->
                            <div
                                x-show="imagePreview"
                                x-cloak
                                class="relative rounded-2xl overflow-hidden border border-gray-700 bg-[#18182f] group"
                            >
                                ...
                                >
                                    ...
                                    <button
                                        type="button"
                                        @click="imagePreview = null; document.getElementById('imageInput').value = ''"
                                        class="px-4 py-2 bg-red-600/90 hover:bg-red-600 text-white text-xs font-semibold rounded-xl backdrop-blur-md shadow-lg transition flex items-center gap-1.5"
                                        title="Remove image"
                                    >
                                        ...
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <path
                                                ...
                                                stroke-linejoin="round"
                                                stroke-width="2"
                                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 2 0 00-2-2h-4a2 2 0 00-2 2v3m4 0H6m6 0h6"
                                            >
                                            </path>
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t border-gray-800">
                            ...
                            <a
                                ...
                                class="px-5 py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-300 text-xs font-semibold rounded-xl transition"
                            >
                                Cancel
                            </a>
                            ...
                            <button
                                type="submit"
                                class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-xs font-semibold rounded-xl shadow-lg shadow-purple-600/30 transition"
                            >
                                Save Event
                            </button>
