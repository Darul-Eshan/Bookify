    ...
    <main class="flex-grow">
                ...
                <div class="glass-card rounded-2xl p-4 sm:p-6 shadow-2xl max-w-5xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="md:col-span-3 relative">
                            ...
                            <i
                                class="fa-solid fa-location-dot absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                            </i>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            ...
            <div class="flex items-center justify-between border-b border-gray-800/80 mb-8 pb-4">
                ...
                <div
                    class="flex items-center gap-3 overflow-x-auto custom-scrollbar pb-2 sm:pb-0 w-full">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                ...
                <div>
                    ...
                    <h2 class="text-xl font-bold text-white flex items-center gap-2">
                        ...
                        <span id="categoryNameTitle" class="text-purple-400">
                            All Events
                        </span>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">
                        Verified e-tickets for events across Bangladesh
                    </p>
            ...
            <div id="eventsGrid"
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div class="relative h-52 overflow-hidden">
                                ...
                                @else
                                    ...
                                    <div
                                        class="w-full h-full bg-[#161626] flex items-center justify-center">

                                        <i
                                            class="fa-solid fa-calendar-days text-4xl text-gray-600">
                                        </i>
                                ...
                                <!-- Image Gradient -->
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-[#161626] via-transparent to-transparent">
                                </div>
                                ...
                                @if($event->date_time)
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="block text-base font-extrabold text-white">
                            ...
                            <div class="p-5">
                                ...
                                <!-- Event Description -->
                                <p
                                    class="text-xs text-gray-400 mt-2 line-clamp-2 leading-relaxed">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <span
                                    class="block text-[10px] text-gray-400 uppercase font-semibold">
                                ...
                                @else
                                    ...
                                    <span
                                        class="text-lg font-extrabold text-emerald-400">
                ...
                @empty
                    ...
                    <!-- No Events -->
                    <div
                        class="col-span-1 md:col-span-2 lg:col-span-3 text-center py-16 glass-card rounded-2xl">

                        <div
                            class="w-16 h-16 bg-purple-600/10 text-purple-400 rounded-full flex items-center justify-center mx-auto mb-4 border border-purple-500/20 text-2xl">
                        ...
                        <p class="text-xs text-gray-400 mt-1">
                            ...
                            Please create an event from the Admin Dashboard.
            ...
            <div
                id="noResults"
                class="hidden text-center py-16 glass-card rounded-2xl my-6">
