...
<div x-data="{ activeCategory: 'All' }">
    ...
    <section class="relative min-h-[520px] flex items-end pb-12 overflow-hidden border-b border-gray-800/30">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 w-full">
            ...
            <div class="max-w-2xl">
                ...
                <p class="text-purple-300 font-medium mb-4 text-lg">
                    Nagar Baul, Artcell, Warfaze
                </p>
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- FIXED ROUTE NAME --}}
                    <a
                        href="{{ route('events.details', 1) }}"
                        class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:opacity-90 text-white font-bold text-lg px-10 py-2.5 rounded-xl shadow-md shadow-purple-600/20 transition flex items-center gap-1.5"
                    >
                        Get Ticket
                    ...
                    <span class="text-sm text-gray-400">
                        From
                        <strong class="text-white text-lg font-bold ml-1">
                            BDT 1,200
                        </strong>
                    </span>
            ...
            @foreach($categories as $category)
                ...
                <button
                    ...
                    :class="activeCategory === '{{ $category }}'
                        ...
                        : 'bg-[#141424] text-gray-400 hover:text-white hover:bg-[#1a1a30] border border-gray-800/60'"
    ...
    <main class="max-w-7xl mx-auto px-6 py-4 pb-16">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a
                href="#"
                class="text-sm font-semibold text-purple-400 hover:text-purple-300 flex items-center gap-1 transition"
            >
                View All
                    ...
                    <div class="pt-4 border-t border-gray-800/60 flex flex-col gap-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs text-gray-400">
                                ...
                                <strong class="text-base text-white font-bold ml-1">
                                    {{ $event['price'] }}
                                </strong>
                            </span>
                        ...
                        {{-- FIXED ROUTE NAME --}}
                        <a
                            href="{{ route('events.details', $index + 1) }}"
                            class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:opacity-90 text-white font-bold text-sm py-2.5 px-4 rounded-xl shadow-md shadow-purple-600/20 transition flex items-center justify-center gap-1.5"
                        >
                            Get Ticket
                            <i class="fa-solid fa-arrow-right text-[10px]"></i>
                        </a>
...
<div class="max-w-7xl mx-auto px-6 mb-12">
    ...
    <div class="relative bg-[#121222] border border-purple-500/30 rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div
            class="relative h-64 md:h-80 w-full overflow-hidden"
            id="imageSlider"
        >
            ...
            <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-100 slide-item">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-[#121222] via-black/50 to-transparent flex flex-col justify-end p-6 md:p-8">
                    ...
                    <span class="bg-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full w-max mb-2">
                        Music Festival
                    </span>
                    ...
                    <p class="text-gray-300 text-sm mt-1">
                        Experience live performances by top bands at Army Stadium.
                    </p>
            ...
            <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0 slide-item">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-[#121222] via-black/50 to-transparent flex flex-col justify-end p-6 md:p-8">
                    ...
                    <span class="bg-indigo-600 text-white text-xs font-bold px-3 py-1 rounded-full w-max mb-2">
                        Technology
                    </span>
                    ...
                    <p class="text-gray-300 text-sm mt-1">
                        Discover software trends and AI innovations at BICC.
                    </p>
            ...
            <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0 slide-item">
                ...
                <img
                    ...
                    alt="Coke Studio Bangla"
                    class="w-full h-full object-cover"
                >

                <div class="absolute inset-0 bg-gradient-to-t from-[#121222] via-black/50 to-transparent flex flex-col justify-end p-6 md:p-8">

                    <span class="bg-pink-600 text-white text-xs font-bold px-3 py-1 rounded-full w-max mb-2">
                        Live Concert
                    </span>

                    <h3 class="text-2xl md:text-3xl font-extrabold text-white">
                        Coke Studio Bangla Live Concert
                    </h3>

                    <p class="text-gray-300 text-sm mt-1">
                        Join the grand musical evening at ICCB, Dhaka.
                    </p>
        ...
        <div class="absolute bottom-4 right-6 z-10 flex gap-2">
            ...
            <button
                class="w-3 h-3 rounded-full bg-white/50 hover:bg-white transition dot-btn active"
                onclick="currentSlide(0)"
            ></button>

            <button
                class="w-3 h-3 rounded-full bg-white/50 hover:bg-white transition dot-btn"
