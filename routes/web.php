...
/*
|--------------------------------------------------------------------------
| 2. Guest Routes (Only Unauthenticated Users)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| 4. Admin Panel Routes (Laravel Built-in 'auth' and 'can' Middleware)
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'can:admin-access'])->prefix('admin')->name('admin.')->group(function () {

    // Admin Dashboard (Super Admin, Admin, Executive, Moderator)
    ...
    Route::middleware(['can:is-executive-above'])->group(function () {
        ...
        // Bookings, Categories, Coupons, Transactions
